...
function setup() {
	...
	rope1=new Rope(Bob5.body,{x:320,y:415},-bobDiameter*2,0);
	rope2=new Rope(Bob4.body,{x:360,y:415},-bobDiameter*1,0);
	rope3=new Rope(Bob1.body,{x:400,y:415},0,0);
	rope4=new Rope(Bob2.body,{x:440,y:415},bobDiameter*1,0);
	rope5=new Rope(Bob3.body,{x:480,y:415},bobDiameter*2,0);
}
